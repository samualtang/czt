...
<script type="text/javascript" src="<spring:url value="/js/jsp/wms/storagearea.js"/>"></script>
  <head>
...
<c:import url="/WEB-INF/jsp/pub/sessionPage.jsp?paramPage=StorageArea"></c:import>
  </body>
</html>
