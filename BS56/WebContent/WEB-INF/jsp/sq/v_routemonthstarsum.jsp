...
<script type="text/javascript" src="<spring:url value="/js/jsp/sq/routemonthstarsum.js"/>"></script>
  <head>
  </head>
...
<c:import url="/WEB-INF/jsp/pub/sessionPage.jsp?paramPage=Routemonthstarsum"></c:import>	
  </body>
</html>