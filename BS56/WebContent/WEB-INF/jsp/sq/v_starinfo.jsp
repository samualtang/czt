   ...
   -->
	...
	<div id="add-dlg" class="easyui-dialog" style="width:550px;height:350px;padding:10px 20px;align:center;"
		...
		<form  id="add-fm" method="post" action="" novalidate  >
			...
			<div class="fitem">
				<label>最小分值</label>
				<input name="minscore" class="easyui-numberbox" style="width:373px;"  data-options="min:0,max:10.01,precision:2,required:true">
			</div>
			<br>
			<div class="fitem">
				<label>最大分值</label>
				<input name="maxscore" class="easyui-numberbox" style="width:373px;"  data-options="min:0,max:10.01,precision:2,required:true">
			</div>
			<br>
