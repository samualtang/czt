...
<script type="text/javascript" src="<spring:url value="/js/jsp/account/operate_storage.js"/>"></script>
  </head>
  <body>
	...
	<div id="add-dlg" class="easyui-dialog" style="width:800px;height:420px;padding:5px 10px;align:center;"
		...
		<input type=hidden name="prestatus"id="prestatus">
			...
			<tr>
		           	...
		           	<td width="5%" height="20" align="left" nowrap>暂存原因：</td>
		           	<td width="14%" height="20" align="left" nowrap>
			...
			<tr>
	           ...
	           <tr>
		            <td width="5%" height="20" align="left" nowrap>暂存数量：</td>
		           	<td width="14%" height="20" align="left" nowrap>
		                <input name="quantity" id="quantity" class="easyui-numberbox" style="width:120px" value="0" readonly>
		           	</td>
		            <td width="5%" height="20" align="left" nowrap>暂存金额：</td>
