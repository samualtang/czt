...
//删除从表FID对应主表ID记录
	...
	@Override
	public List<RoutescoreVo> getRoutescoreMarketPageList(Pagination<?> page) {
		// TODO Auto-generated method stub
		Map<String, String> sortKeyMap = new HashMap<>();
		sortKeyMap.put("routecode", "routecode");
		sortKeyMap.put("license", "license");
		sortKeyMap.put("custname", "custname");
		page.sortKeyToColumn(sortKeyMap);
		return this.routescoreVoMapper.getRoutescoreMarketPageList(page);
	}

	@Override
	public long getRouteScoreId() {
		// TODO Auto-generated method stub
		return this.routescoreVoMapper.getRouteScoreId();
	}

	@Override
	public void insertSummarySelective(RoutescoreVo routescoreVo) {
		// TODO Auto-generated method stub
		routescoreVoMapper.insertSummarySelective(routescoreVo);
	}

	@Override
	public void insertLineSelective(RoutescoreVo routescoreVo) {
		// TODO Auto-generated method stub
		routescoreVoMapper.insertLineSelective(routescoreVo);
	}
