...
<head>
<meta charset="utf-8">
<link href="<spring:url value="/css/main/css/base.css"/>" rel="stylesheet" type="text/css" />
<link href="<spring:url value="/css/main/css/home.css"/>" rel="stylesheet" type="text/css" />
...
<div class="article toolbar">
    ...
    <div class="content">
    	<ul class="toollist ue-clear">
    		<li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon01.png"/>" /></a>
                <p><a href="javascript:;">通知公告</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon02.png"/>" /></a>
                <p><a href="javascript:;">知识库</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon03.png"/>" /></a>
                <p><a href="javascript:;">密码修改</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon04.png"/>" /></a>
                <p><a href="javascript:;">日程安排</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon05.png"/>" /></a>
                <p><a href="javascript:;">添加文章</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon06.png"/>" /></a>
                <p><a href="javascript:;">网络硬盘</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon07.png"/>" /></a>
                <p><a href="javascript:;">参数信息</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon08.png"/>" /></a>
                <p><a href="javascript:;">回收站</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="<spring:url value="/css/main/images/icon09.png"/>" /></a>
                <p><a href="javascript:;">系统配置</a></p>
            </li>
            <li class="add-btn">
            	<img src="<spring:url value="/css/main/images/add.png"/>" />
            </li>
    	</ul>
...
<script type="text/javascript" src="<spring:url value="/js/jsp/main/common.js"/>"></script>
