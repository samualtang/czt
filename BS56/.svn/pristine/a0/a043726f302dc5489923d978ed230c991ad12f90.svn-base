...
<script type="text/javascript" src="<spring:url value="/js/jsp/cost/splconsume.js"/>"></script>
  <head>
  ...
  <body>
	...
	<form id="queryForm" style="margin:10;">
		...
		<a href="#" id="newBtn" class="easyui-linkbutton" iconCls="icon-view" plain="true" onclick="viewD()">查看</a>
			<a href="#" id="settingBtn" class="easyui-linkbutton" iconCls="icon-mysetting" plain="true" onclick="openAudit()">发料</a>
          ...
          <tr>
			  <td colspan="5">
                    <input name="lvl1" id="lvl1" class="easyui-combobox"style="width:auto;"  >
						...
						<input name="lvl3" id="lvl3" class="easyui-combobox"style="width:auto;"  >
                   或:<input class="easyui-textbox"  name="condname" id="condname" data-options="buttonText:'查询',buttonIcon:'icon-search',onClickButton:function(){searchType();},prompt:'请输入物资名称...'" style="width:200px;height:24px;">
           ...
           <tr>
			...
			<input type="hidden" name="splid" id="splid"></input>
			...
			<input type="hidden" name="keeperid" id="keeperid" ></input>
			
		</form>
	 <div id="dlg-buttons">
		<a href="#" class="easyui-linkbutton" id="btn-save" iconCls="icon-ok" onclick="saveNew()">保存</a>
		<a href="#" class="easyui-linkbutton" id="btn-audit" iconCls="icon-ok" onclick="doAudit('50')">发料</a>
