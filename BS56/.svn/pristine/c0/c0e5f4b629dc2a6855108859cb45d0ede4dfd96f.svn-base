...
public class DeptVo {
    ...
    /**
     * sys备注信息
     * @param sysremarks sys备注信息
     */
    public void setSysremarks(String sysremarks) {
        this.sysremarks = sysremarks == null ? null : sysremarks.trim();
    }

    /**
     * sync标志(上级部门id)
     * @return FID sync标志(上级部门id)
     */
