...
<script type="text/javascript" src="<spring:url value="/js/jsp/cost/deptconsume.js"/>"></script>
...
<input type=hidden name="param" id="param">
	...
	<form id="queryForm" style="margin:10;" method="post">
		<div style="margin-bottom:5px">
			...
			<a href="#" onclick="searchConsume();" class="easyui-linkbutton" iconCls="icon-search" style="height:24px;">查询</a>
	...
	<!-- 打印窗口 -->
	<!--startprint-->
	<div id="print-dlg" class="easyui-dialog" style="width:900px;height:450px;padding:10px 20px;align:center;"  data-options="modal:true,draggable:false"
